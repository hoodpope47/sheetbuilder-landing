  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-50 flex items-center justify-center px-4">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 md:flex-row">
        {/* LEFT: Hero */}
        <section className="flex-1 rounded-3xl border border-slate-800 bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 px-8 py-8 shadow-[0_0_80px_rgba(15,23,42,0.9)]">
        ...
        <section className="flex-1">
          <div className="rounded-3xl border border-slate-800 bg-slate-950/80 px-6 py-7 shadow-[0_0_80px_rgba(15,23,42,0.9)] backdrop-blur">
